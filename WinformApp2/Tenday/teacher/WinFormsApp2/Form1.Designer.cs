namespace WinFormsApp2
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            menuStrip1.Items.AddRange(new ToolStripItem[] { 文件ToolStripMenuItem, 编辑ToolStripMenuItem, 格式ToolStripMenuItem, 搜索ToolStripMenuItem });
            ...
            // 文件ToolStripMenuItem
            // 
            文件ToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { 新建ToolStripMenuItem, 新窗口ToolStripMenuItem, 打开ToolStripMenuItem, 保存ToolStripMenuItem, 文件FToolStripMenuItem });
            文件ToolStripMenuItem.Name = "文件ToolStripMenuItem";
            文件ToolStripMenuItem.Size = new Size(71, 24);
            文件ToolStripMenuItem.Text = "文件(&F)";
            // 
            // 新建ToolStripMenuItem
            // 
            新建ToolStripMenuItem.Name = "新建ToolStripMenuItem";
            新建ToolStripMenuItem.ShortcutKeyDisplayString = "Ctrl+N";
            新建ToolStripMenuItem.Size = new Size(202, 26);
            新建ToolStripMenuItem.Text = "新建(&N)";
            // 
            // 新窗口ToolStripMenuItem
            // 
            新窗口ToolStripMenuItem.Name = "新窗口ToolStripMenuItem";
            新窗口ToolStripMenuItem.Size = new Size(202, 26);
            新窗口ToolStripMenuItem.Text = "新窗口";
            // 
            // 打开ToolStripMenuItem
            // 
            打开ToolStripMenuItem.Name = "打开ToolStripMenuItem";
            打开ToolStripMenuItem.Size = new Size(202, 26);
            打开ToolStripMenuItem.Text = "打开";
            // 
            // 保存ToolStripMenuItem
            // 
            保存ToolStripMenuItem.Name = "保存ToolStripMenuItem";
            保存ToolStripMenuItem.Size = new Size(202, 26);
            保存ToolStripMenuItem.Text = "保存";
            // 
            // 文件FToolStripMenuItem
            // 
            文件FToolStripMenuItem.Name = "文件FToolStripMenuItem";
            文件FToolStripMenuItem.Size = new Size(202, 26);
            ...
            // 格式ToolStripMenuItem
            // 
            格式ToolStripMenuItem.Image = (Image)resources.GetObject("格式ToolStripMenuItem.Image");
            格式ToolStripMenuItem.Name = "格式ToolStripMenuItem";
            格式ToolStripMenuItem.Size = new Size(73, 24);
            格式ToolStripMenuItem.Text = "格式";
            // 
            // 搜索ToolStripMenuItem
            // 
            搜索ToolStripMenuItem.Image = (Image)resources.GetObject("搜索ToolStripMenuItem.Image");
            搜索ToolStripMenuItem.Name = "搜索ToolStripMenuItem";
            搜索ToolStripMenuItem.Size = new Size(73, 24);
            搜索ToolStripMenuItem.Text = "搜索";
            // 
            // toolStrip1
            // 
            toolStrip1.ImageScalingSize = new Size(20, 20);
            toolStrip1.Items.AddRange(new ToolStripItem[] { toolStripButton1, toolStripLabel1, toolStripSeparator1, toolStripComboBox1, toolStripDropDownButton1, toolStripTextBox1 });
            toolStrip1.Location = new Point(0, 28);
            toolStrip1.Name = "toolStrip1";
            toolStrip1.Size = new Size(984, 28);
            ...
            toolStripLabel1.Size = new Size(39, 25);
            toolStripLabel1.Text = "复制";
            // 
            // toolStripSeparator1
            // 
            ...
            // toolStripComboBox1
            // 
            toolStripComboBox1.Items.AddRange(new object[] { "Debug", "Releas", "WinFormsApp1", "WinFormsApp2" });
            toolStripComboBox1.Name = "toolStripComboBox1";
            toolStripComboBox1.Size = new Size(130, 28);
