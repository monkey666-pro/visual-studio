namespace WinFormsApp1.Controls
{
    partial class UCBook
    {
        ...
        private void InitializeComponent()
        {
            ...
            // nameInp
            // 
            nameInp.Location = new Point(207, 82);
            nameInp.Margin = new Padding(2, 3, 2, 3);
            nameInp.Name = "nameInp";
            nameInp.PlaceholderText = "请输入图书名称";
            nameInp.Size = new Size(217, 63);
            nameInp.TabIndex = 2;
            // 
            // label3
            // 
            ...
            // input3
            // 
            input3.Location = new Point(207, 371);
            input3.Margin = new Padding(2, 3, 2, 3);
            input3.Multiline = true;
            input3.Name = "input3";
            input3.PlaceholderText = "请输入图书标签(一行一个)";
            input3.Size = new Size(217, 114);
            input3.TabIndex = 2;
            // 
            // priceInpNum
            // 
            priceInpNum.Location = new Point(207, 281);
            priceInpNum.Margin = new Padding(2, 3, 2, 3);
            priceInpNum.Name = "priceInpNum";
            priceInpNum.PlaceholderText = "请输入图书价格";
            priceInpNum.Size = new Size(217, 63);
            ...
            button1.Location = new Point(183, 490);
